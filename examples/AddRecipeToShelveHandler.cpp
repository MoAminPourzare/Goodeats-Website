...
AddRecipeToShelveHandler::AddRecipeToShelveHandler(Goodeats* _goodeats_) : goodeats(_goodeats_) {}

Response *AddRecipeToShelveHandler::callback(Request *req) {
	...
	body
		...
		<< "<html>" << endl
		<< "	<head>" << endl
		<< "		<title>AddRecipeToShelve</title>" << endl
		<< "	</head>" << endl
		<< "	<body style='text-align: center;'>" << endl
		<< "		<h1>**Add Recipe To Shelve**</h1>" << endl
		...
		<< "			<form action='/AddRecipeToShelve' method='post' style='text-align: center;'>" << endl
